...
public class LZHuff {
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            ...
            System.out.println("Usage: \njava LZHuff (encode | decode) <in_file> <out_file>");
            System.out.println("Example: \njava LZHuff encode walden.pdf simplify!.encoded");
            System.exit(1);
        }
        ...
        if (operation.equals("encode")) {
            ...
            LZHuff.decode(inputPath, outputPath);
        } else {
            System.out.printf("bad input: '%s' is an unknown operation", operation);
            System.out.println("Usage: \njava LZHuff (encode | decode) <in_file> <out_file>");
            System.out.println("Example: \njava LZHuff encode walden.pdf simplify!.encoded");
            System.exit(1);
        }
    ...
    public static void encode(String inputPath, String outputPath) {
        ...
        try {
            ...
            byte[] LZEncoded = LZ.compress(input);
    ...
    public static void decode(String inputPath, String outputPath) {
        ...
        try {
            ...
            byte[] decompressed = LZ.decode(huffmanDecoded);

...
fn generate_sphere(radius: f32, longitude_segments: u32, latitude_segments: u32) -> (Vec<f32>, Vec<u32>) {
...
fn main() {
    ...
    let render_thread = thread::spawn(move || {
        ...
        // let (vertices, indices) = generate_sphere(0.5, 32, 32);
        ...
        let shader = unsafe { 
            shader::ShaderBuilder::new()
                .attach_file("./shaders/flip.vert")
                .attach_file("./shaders/cool.frag")
                .link()
        };
